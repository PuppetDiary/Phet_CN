    ...
    public static readonly FeedbackManagerIO = new IOType<FeedbackManager, FeedbackManager>('FeedbackManagerIO', {
        ...
        methods: {
            reset: {
                returnType: VoidIO,
                parameterTypes: [],
                implementation: function (this: FeedbackManager) { this.reset(); },
            ...
            setEnabled: {
                returnType: VoidIO,
                parameterTypes: [],
                implementation: function (this: FeedbackManager) { this.setEnabled(true); },
...
energySkatePark.register('FeedbackManager', FeedbackManager);
